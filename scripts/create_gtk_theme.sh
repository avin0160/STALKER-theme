...
/* Remove blue from switches - COMPREHENSIVE FIX */
switch {
    background-color: #4a5a4d !important;  /* Unchecked state - grey */
    border: 1px solid #5f7060 !important;
}

switch:checked {
    background-color: #5f7060 !important;  /* STALKER GREEN instead of blue */
    border-color: #7f9080 !important;
}

switch slider,
switch:checked slider {
    background-color: #e9e5d4 !important;  /* Light slider */
    border: 1px solid #5f7060 !important;
}

/* Hover states */
switch:hover {
    background-color: #5a6a5d !important;
}
...
/* Force override any blue switches */
switch,
switch *,
.switch,
.switch * {
    background-color: #4a5a4d !important;
}
...
.switch:checked,
.switch:checked * {
    background-color: #5f7060 !important;  /* FORCE STALKER GREEN */
}
...
/* File chooser dialogs - make them SOLID */
filechooser,
.filechooser,
dialog,
.dialog {
    background-color: #3a4d3e;
    opacity: 1.0;  /* Full opacity for dialogs */
}
